...
export interface PhotoBackupSettings { enabled: boolean; photos: boolean; videos: boolean; wifiOnly: boolean; encrypt: boolean; }
...
const defaultSettings: PhotoBackupSettings = { enabled: false, photos: true, videos: true, wifiOnly: false, encrypt: false };
