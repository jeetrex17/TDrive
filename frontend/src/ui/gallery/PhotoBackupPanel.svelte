...
<section class="photo-backup-panel" aria-label="Photo and video backup" aria-busy={$busy}>
    ...
    {#if $backupState}
        ...
        <p class="backup-access">Originals stay on your device. Keep TDrive open for backup; it resumes when reopened.</p>
